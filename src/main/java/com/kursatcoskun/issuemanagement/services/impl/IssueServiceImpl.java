...
public class IssueServiceImpl implements IssueService {
    ...
    @Override
    public List<IssueDto> getAllIssuesByAssigneeAndIssueStatus(Long id, IssueStatus issueStatus) {
        User user = userRepository.getOne(id);
        List<Issue> issues = issueRepository.findAllByAssigneeAndIssueStatusAndStatus(user, issueStatus, true);
